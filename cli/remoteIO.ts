...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.VIBECODE_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.VIBECODE_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.VIBECODE_ENVIRONMENT_KIND === 'bridge'
