 ...
 *
 * Each teammate has an inbox file at .vibecode/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.vibecode/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to VIBECODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's VIBECODE_AGENT_ID */
  workerId: string
  /** Worker's VIBECODE_AGENT_NAME */
  workerName: string
  /** Worker's VIBECODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to VIBECODE_TEAM_NAME env var)
