...
/**
 * Detects if a file path is a session-related file under ~/.vibecode.
 ...
 * Excludes: CLAUDE.md, CLAUDE.local.md, .vibecode/rules/*.md (user-managed).
 *
...
// Excludes CLAUDE.md, CLAUDE.local.md, .vibecode/rules/ (user-managed).
