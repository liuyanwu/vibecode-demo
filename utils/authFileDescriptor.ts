 ...
 * /home/claude/.vibecode/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/claude/.vibecode/remote'
 ...
 * rationale. Env var: VIBECODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.vibecode/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'VIBECODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: VIBECODE_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.vibecode/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'VIBECODE_API_KEY_FILE_DESCRIPTOR',
