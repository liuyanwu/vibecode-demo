...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.vibecode/skills)
  ...
  // User commands directory (~/.vibecode/commands)
  ...
  // Project skills directory (.vibecode/skills)
  ...
  // Project commands directory (.vibecode/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.vibecode', 'skills')
    try {
