 ...
 * variables instead: VIBECODE_AGENT_ID, VIBECODE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from VIBECODE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
