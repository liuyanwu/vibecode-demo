 ...
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'VIBECODE_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'VIBECODE_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'VIBECODE_PLAN_MODE_REQUIRED'
