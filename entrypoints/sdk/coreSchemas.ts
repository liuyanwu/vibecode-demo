  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.vibecode/agent-memory/<agentType>/, 'project' - .vibecode/agent-memory/<agentType>/, 'local' - .vibecode/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.vibecode/settings.json). " +
        "'project' - Project settings (.vibecode/settings.json). " +
        "'local' - Local settings (.vibecode/settings.local.json).",
    ),
)
