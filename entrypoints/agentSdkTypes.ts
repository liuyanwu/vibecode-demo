 ...
 *
 * If your SDK MCP calls will run longer than 60s, override VIBECODE_STREAM_CLOSE_TIMEOUT
 */
...
/**
 * A scheduled task from `<dir>/.vibecode/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.vibecode/scheduled_tasks.json` and yield events as tasks fire.
 *
