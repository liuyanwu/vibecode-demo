...
//   protoc               unknown
// source: events_mono/claude_code/v1/VIBECODE_internal_event.proto
...
export interface EnvironmentMetadata {
  ...
  is_VIBECODE_ACTION?: boolean | undefined
  ...
  is_VIBECODE_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  VIBECODE_container_id?: string | undefined
  VIBECODE_remote_session_id?: string | undefined
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    arch: '',
    is_VIBECODE_remote: false,
    remote_environment_type: '',
    VIBECODE_container_id: '',
    VIBECODE_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_VIBECODE_ACTION: isSet(object.is_VIBECODE_ACTION)
        ? globalThis.Boolean(object.is_VIBECODE_ACTION)
        : false,
      ...
      is_VIBECODE_remote: isSet(object.is_VIBECODE_remote)
        ? globalThis.Boolean(object.is_VIBECODE_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      VIBECODE_container_id: isSet(object.VIBECODE_container_id)
        ? globalThis.String(object.VIBECODE_container_id)
        : '',
      VIBECODE_remote_session_id: isSet(object.VIBECODE_remote_session_id)
        ? globalThis.String(object.VIBECODE_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_VIBECODE_ACTION !== undefined) {
      obj.is_VIBECODE_ACTION = message.is_VIBECODE_ACTION
    }
    ...
    if (message.is_VIBECODE_remote !== undefined) {
      obj.is_VIBECODE_remote = message.is_VIBECODE_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.VIBECODE_container_id !== undefined) {
      obj.VIBECODE_container_id = message.VIBECODE_container_id
    }
    if (message.VIBECODE_remote_session_id !== undefined) {
      obj.VIBECODE_remote_session_id = message.VIBECODE_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_VIBECODE_ACTION = object.is_VIBECODE_ACTION ?? false
    ...
    message.is_VIBECODE_remote = object.is_VIBECODE_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.VIBECODE_container_id = object.VIBECODE_container_id ?? ''
    message.VIBECODE_remote_session_id =
      object.VIBECODE_remote_session_id ?? ''
